...
Two themes: **Wind** (light, airflow) and **Night Sky** (dark, constellations).
...
| `LOGBOOK_TILE_URL_LIGHT` | CARTO light | Map tiles for Wind theme |
| `LOGBOOK_TILE_URL_DARK` | CARTO dark | Map tiles for Night Sky theme |
